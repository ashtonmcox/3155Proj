...
def test_create_feedback(db_session):
    ...
    assert created_feedback.order_id == feedback_data["order_id"]
...
def test_update_feedback(db_session):
    ...
    db_session.query.return_value.filter.return_value.first.return_value = existing_feedback
...
def test_get_feedback(db_session):
    ...
    assert retrieved_feedback.order_id == 101
